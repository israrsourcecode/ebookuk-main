    ...
    <>
          ...
          <div className="row">
            <div className="col-12 col-md-12 col-lg-6">
              <div className="hero-data">
                <HeroTitle heading={<>About <span> Us</span></>} headingpara={<>We Serve As A Bridge Between Your Draft And Your Readers</>} para={"We have simplified book writing and made it fast and affordable. We assist every author in publishing books of any genre."} />
              </div>
              <div className="buttons">
                <Button link={"/"} name={"red"} value={"Get a Quote"} />
                <Button link={"/"} name={"white"} value={"Chat With Us"} />
              </div>
            </div>
            {/* <div className="col-12 col-md-12 col-lg-6">
      ...
      <section className="about-sec-1">
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-12 col-lg-6">
              <div className="about-sec-1-data">
                <HeadingCenter name={"left"} heading={"Built for Writers Who Refuse to Keep Their Stories Locked Away"} para={"Our platform was founded on a simple idea: great stories must not remain hidden in notebooks or lost folders. Too many authors find it hard to get their manuscript published as a book. The process feels confusing. Most writers get lost before they start. Our site is here to eliminate those obstacles. We stay with authors from the time when a manuscript is created until the book is in the hands of readers all over the world."} />
                <div className="buttons">
                  <Button link={"/"} name={"red"} value={"Get a Quote"} />
            ...
            <div className="col-12 col-md-12 col-lg-6">
              <div className="about-sec-1-img">
                <img className="img-fluid" src="./../src/assets/images/about-1.webp" alt="" />
              </div>
            </div>
          </div>
        </div>
